...
public class HalfSlab : BlockMesh {
	...
	public HalfSlab () {
		...
		this.faces[0].vertData[1] = new VertData (new Vector3 (0, 0.5f, 0), new Vector2 (0, 0.5f));
		this.faces[0].vertData[2] = new VertData (new Vector3 (1, 0.5f, 0), new Vector2 (1, 0.5f));
		...
		this.faces[1].vertData[0] = new VertData (new Vector3 (0, 0, 0), new Vector2 (0, 0));
		this.faces[1].vertData[1] = new VertData (new Vector3 (0, 0.5f, 0), new Vector2 (0, 0.5f));
		this.faces[1].vertData[2] = new VertData (new Vector3 (1, 0.5f, 0), new Vector2 (1, 0.5f));
		this.faces[1].vertData[3] = new VertData (new Vector3 (1, 0, 0), new Vector2 (1, 0));
		...
		this.faces[4].vertData[1] = new VertData (new Vector3 (0, 0.5f, 0), new Vector2 (0, 0.5f));
		this.faces[4].vertData[2] = new VertData (new Vector3 (0, 0.5f, 1), new Vector2 (1, 0.5f));
		...
		this.faces[5].vertData[1] = new VertData (new Vector3 (1, 0.5f, 0), new Vector2 (0, 0.5f));
		this.faces[5].vertData[2] = new VertData (new Vector3 (1, 0.5f, 1), new Vector2 (1, 0.5f));
